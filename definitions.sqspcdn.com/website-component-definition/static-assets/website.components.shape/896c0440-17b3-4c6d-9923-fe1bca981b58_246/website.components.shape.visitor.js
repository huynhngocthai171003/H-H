websiteComponents.loader.define("website.components.shape.visitor", [], (() => (() => {
    ...
    var e = {
            ...
            9998: function(e, t, r) {
                ...
                function p(e, r) {
                    ...
                    }(e) ? (R(r), e.getElementsByClassName("sqs-shape-block-container")[0].classList.remove("hidden-stretch-block")) : d.attachResizeObserver({
                        observerName: t.RESIZE_OBSERVER_NAME,
                        resizeListenerTarget: e,
                        callback: () => O(e, r)
                    }))
                ...
                function O(e, t) {
                    ...
                    const i = e.clientWidth,
                        ...
                        l = s / o,
                        d = {},
                        u = i / n > l ? "height" : "width";
                    d[u] = "100%", "height" === u ? d.width = n * l + "px" : d.height = i / l + "px", c(t, d)
                }
                ...
                t.RESIZE_OBSERVER_NAME = "shapeFit", t.setPreserveAspectRatio = u, t.syncDimensionsForShape = p, t.adjustDimensionsForShapeFit = O, t.adjustDimensionsForShapeFill = R, t.initializeShapeBlockInVisitorView = function(e) {
    ...
    return (() => {
        ...
        class o {
            ...
            render() {
                (0, t.initializeShapeBlockInVisitorView)(this.root)
            }
        }
